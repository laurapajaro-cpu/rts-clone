...
export default function Headers({ onPhase }) {
          ...
          <div className="heroH-viewport">
            <section className="heroH-panel heroH-panel--first">
              <div className="heroH-inner">
                ...
                <Button children="Our Approach" onClick={() => {navigate("/approach/automation")}} />
              </div>
            </section>
            ...
            <section className="heroH-panel">
              <div className="heroH-inner">
                ...
                <Button children="Our Approach" onClick={() => {navigate("/approach/digital")}} />
              </div>
            </section>
            ...
            <section className="heroH-panel">
              <div className="heroH-inner heroH-body-mobile">
                ...
                <Button children="Our Approach" onClick={() => {navigate("/approach/energy")}} />
              </div>
